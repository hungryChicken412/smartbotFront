        ...
        >
          <SubMenuWrapper>
            <List component="div">
              ...
              <ListItem component="div">
                <NextLink href="/applications/chatbotDesigner" passHref>
                  <Button
                    className={
                      currentRoute === '/applications/chatbotDesigner'
                        ? 'active'
                        : ''
                    }
                    disableRipple
              ...
              <ListItem component="div">
                <NextLink href="/management/bots" passHref>
                  <Button
                    className={
                      currentRoute === '/management/bots' ? 'active' : ''
                    }
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
